...
public class EditCell<S, T> extends TextFieldTableCell<S, T> {
    ...
    public void updateItem(T item, boolean empty) {
        ...
        if (tableRow != null && tableRow.getItem() instanceof Tablerow) {
            Tablerow tablerow = (Tablerow) tableRow.getItem();
            if (tablerow.isDeleted()) {
                tableRow.setStyle("-fx-background-color:red");
            }else if(tablerow.isUpdated()){
                tableRow.setStyle("-fx-background-color:darkviolet");
            }else if(tablerow.isInserted()){
                tableRow.setStyle("-fx-background-color:yellow");
                tableRow.setStyle("-fx-text-inner-color: purple;");
            }
        }
        updateItem();
    }
